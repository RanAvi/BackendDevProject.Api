...
namespace BackendDevProject.Respository.DatabaseConig
{
    public class CustomUserStore : IUserStore<ApplicationUser>, IUserPasswordStore<ApplicationUser>, IDisposable
    {
        ...
        public SqliteConnection GetConnection { get { return new SqliteConnection($"Data Source={_configuration.DatabaseName}"); } }

        public CustomUserStore(DatabaseConfiguration configuration, IPasswordHasher<ApplicationUser> passwordHasher)
        {
